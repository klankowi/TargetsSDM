...
# "Filters"
nice_species_name = "Atlantic_cod_Base"
nice_climate_name = "SSP5_85_mean"

proj_file<- paste0(nice_species_name, "-", nice_climate_name, "_projections.rds")
...
#biomass_dat<- make_spatial_index(vast_proj_rds = vast_proj_rds, vast_fit = vast_fit, spatial_areas = spatial_areas, nice_times = nice_times, nice_species_name = nice_species_name, nice_climate_name = nice_climate_name, out_dir = "/Users/aallyn/Library/CloudStorage/Box-Box/Mills Lab/Projects/sdm_workflow/DFOSDM_app/spatial_summary/")
biomass_dat<- make_spatial_index(vast_proj_rds = vast_proj_rds, vast_fit = vast_fit, spatial_areas = spatial_areas, nice_times = nice_times, nice_species_name = nice_species_name, nice_climate_name = nice_climate_name, out_dir = "/Users/aallyn/Library/CloudStorage/Box-Box/Mills Lab/Projects/sdm_workflow/DFOSDM_app/spatial_summary_no_ST/")
